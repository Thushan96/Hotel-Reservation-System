...
public class DeleteMealFormController {
    ...
    public void PressToDelete(ActionEvent actionEvent) {
        deleteBtn.setOnAction(event -> {
            ...
            Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Are you sure You want to delete the meal plan?", yes, no);
            final Optional<ButtonType> result=alert.showAndWait();
            if(result.orElse(no)==yes){
                new Alert(Alert.AlertType.INFORMATION,"Meal plan deleted",ButtonType.CLOSE).show();
